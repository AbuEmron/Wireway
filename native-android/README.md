...
| **6** | Final parity | Deeper money (AR aging, per-job P&L, accountant CSV export); bundle the actual brand .ttf binaries; WorkManager-backed background sync; offline image queueing for receipts |
