...
val DarkBackground = Color(0xFF060810)        // deep near-black, slight blue cast
val DarkOnBackground = Color(0xFFECEFF9)
val DarkSurface = Color(0xFF0D1020)           // cards
val DarkOnSurface = Color(0xFFECEFF9)
val DarkSurfaceVariant = Color(0xFF161A2E)    // raised cards
